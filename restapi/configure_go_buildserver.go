...
//go:generate swagger generate server --target ../../go-buildserver --name GoBuildserver --spec ../swagger.yaml --principal interface{}

func configureFlags(api *operations.GoBuildserverAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.GoBuildserverAPI) http.Handler {
